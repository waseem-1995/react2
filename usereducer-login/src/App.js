    ...
    <div className="App">
      ...
      <form className="form-wrapper" data-testid="form-wrapper" onSubmit={submitHandler}>
        <div className="useremail-wrapper">
          ...
          <input type="email" data-testid="user-email" value={state.email}
          onChange={(e)=>dispatch({type:"email",payload:e.target.value})} />
        </div>
        <div className="userpassword-wrapper">
          <label>User Password</label>
          <input type="password" data-testid="user-password" value={state.password} 
      ...
      {/* IF there is data in the submittedData variable after submitting the form, show the data here ELSE show the No details found div. */}
        ...
        {submittedData.email||submittedData.password ?
          ...
          :(
            <div data-testid="no-details-container">
              <div data-testid = "no-user-container"> no details found </div>
            </div>
          )
        }
    </div>
